...
DeepLaw 的三个冻结产品角色共享一个治理内核：Task Continuity / Governed Project Knowledge、
Source-native Evidence Library（Legal Pack 属于此策略面）和 Living Wiki。三者共同使用
...
官方目录、用户私有法律参考与客户/案件项目必须物理隔离。当前 `v0.12.0` 不提供内容级
