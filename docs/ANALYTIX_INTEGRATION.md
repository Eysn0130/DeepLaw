...
Status: reviewed against DeepLaw `v0.10.0`, 2026-07-30.
...
一个外部、只读、版本化的官方法律能力。DeepLaw 2.0 当前软件版本 `v0.10.0` 另有用户私有法律参考资料范围，
...
DeepLaw 2.0 当前软件版本 `v0.10.0` 使用 MCP SDK 的低层 `Server`，只支持本地 stdio transport；它不是 HTTP
