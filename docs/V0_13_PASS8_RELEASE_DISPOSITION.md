...
| evaluated candidate commit | `a6176b9a60c7286ba2251369913656aeafeadb63` |
| evaluated candidate tree | `5f44d98458c07a00fcb39da45b180611a3959ce8` |
...
`AGENTS.md` was not changed again.
...
|---|---|---|
| deterministic lifecycle v2 | `passed`; `semanticdeterministic_596e40e38b8515906a25cbc8` | `b727342109cb693608e21180aa4938bb9b8c3844b745eb127803656c0d669a42` |
| semantic query run | `passed` 15/15 canonical, 14/14 variants; `semanticqueryrun_b633a13d3f35d07f700c08ce` | `d0abee89233c759e86b11d45a6573b9033573706d215ead6e432b2ba18a9c4e7` |
| Context v2 | `passed` 15/15; `semanticcontextoutcome_81cf1a486483d99862726171` | `2fa5aef2927cc63978aebf0464e70a6a0d58bcbb2730e2ca139822b7ea800b57` |
| query cost v2 | actual Provider input tokens remain `null` | `6df765405a319f1b9de4979fb087e94c84505346e84f941ade9b7c543d619bba` |
...
The claim-ineligible 1k construction report is bound to the evaluated candidate. File SHA-256 is
`ae96056ac2a5c34699bd7789f64db93cca5cba808f59c76a98abf0b4065a6b8f`; self-addressed report
SHA-256 is `453886430bb09164dff6bc873b1401aadd2acafb200d6ab4254b369fed4c702f`.
...
The dedicated 10,000-request RSS child-process lane and 10k/100k scale lanes remain
`not_executed`. The report is not a release or competitive performance claim.
...
| Artifact | SHA-256 |
|---|---|
| `deeplaw-0.12.0-py3-none-any.whl` | `5e36bda5b3b01a00b33804b023d361d24595ebd5a1613892e24ec0436e79e490` |
| `deeplaw-0.12.0.tar.gz` | `2f6ee597ae591573f2264ce256e6a3d24900727346f9ecca76ee1d328e7916d7` |
...
Focused regression, contract, Ruff, and `git diff --check` checks passed for each change. The one
...
canonical-read fix passed all 18 affected persistent-runtime tests, including missing-derived and
symlink rejection. `uv lock --check`, full Ruff, and `git diff --check` passed. Per the frozen
validation policy, the entire suite was not repeated after each focused correction.
...
- 5k/10k/100k Wiki/Relation scale, dedicated RSS stability, and full release concurrency/cache
  matrix;
