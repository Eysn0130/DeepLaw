...
Status: **v0.7 compatibility CLI retained by v0.10.0**, reviewed 2026-07-30. New Vaults and autonomous migration use
...
```bash
uv tool install https://github.com/Eysn0130/DeepLaw/releases/download/v0.10.0/deeplaw-0.10.0-py3-none-any.whl
```
