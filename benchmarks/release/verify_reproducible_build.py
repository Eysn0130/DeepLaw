...
_REQUIRED_SDIST_PATHS = (
    ...
    "benchmarks/hosts/pass17_development_diagnostic.py",
    ...
    "benchmarks/release/freeze_qualification_candidate_v2.py",
    "benchmarks/release/prepare_v013_candidate.py",
    ...
    "benchmarks/release/release_provenance_v8.py",
    ...
    "benchmarks/release/security_domain_receipt.py",
    ...
    "benchmarks/release/assemble_commercial_qualification_v8.py",
    "benchmarks/release/external_qualification_bundle_v4.py",
    ...
    "contracts/commercial-release-manifest.v8.schema.json",
    "contracts/external-qualification-bundle-manifest.v4.schema.json",
    "contracts/host-continuity-human-gold.v1.schema.json",
    "contracts/host-continuity-human-gold.v2.schema.json",
    "contracts/host-continuity-pass16-blind-review.v1.schema.json",
    "contracts/host-continuity-pass16-run-score.v1.schema.json",
    "contracts/host-continuity-pass17-blind-review.v2.schema.json",
    "contracts/host-continuity-pass17-run-score.v2.schema.json",
    "contracts/host-continuity-development-diagnostic.v1.schema.json",
    "contracts/host-continuity-qualification.v1.schema.json",
    "contracts/host-continuity-qualification.v2.schema.json",
    ...
    "contracts/v013-active-qualification.v2.schema.json",
    "contracts/v013-qualification-protocol.v2.schema.json",
    "contracts/v013-release-gate-classification.v8.schema.json",
    "contracts/security-domain-receipt.v1.schema.json",
    "contracts/typed-qualification-evidence.v2.schema.json",
    "benchmarks/v013/active-qualification-v2.json",
    "benchmarks/v013/qualification-protocol-v2.json",
    "benchmarks/v013/qualification-protocol-v2.sha256",
