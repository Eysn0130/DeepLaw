    ...
    "retention-a": [
        {
            ...
            "body": (
                ...
                "retained for exactly 30 days during 2026. Restricted payloads are never included "
                "in diagnostic logs."
            ),
            "aliases": [],
    ...
    "retention-b": [
        {
            ...
            "body": (
                ...
                "generated by public API requests in the worldwide tenant population to be "
                "retained for exactly 60 days during 2026. Restricted payloads are never included "
                "in diagnostic logs."
            ),
            "aliases": [],
            "valid_from": "2026-01-01T00:00:00Z",
        ...
        },
        {
            ...
            "body": (
                ...
                "Policy A requires 30 days while Policy B requires 60 days. Restricted payloads "
                "are never included in either policy's diagnostic logs."
            ),
            "aliases": [],
