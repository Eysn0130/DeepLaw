    ...
    "cross-packet-entity": [
        {
            ...
            "aliases": ["MRC", "Meridian Research", "the Cooperative"],
        }
    ],
    "ambiguous-entities": [
        {
    ...
    "concept-procedure-events": [
        {
            ...
            "body": (
                "Evidence admission is an admission policy requiring identity, lifecycle, scope, "
                "sensitivity, and provenance checks. Ranking never establishes Authority."
            ),
    ...
    "retention-a": [
        {
            ...
            "body": (
                "Policy A requires Atlas production public API diagnostic logs for the worldwide "
                "tenant population to be retained for exactly 30 days during 2026."
            ),
            "aliases": [],
    ...
    "retention-b": [
        {
            ...
            "body": (
                "Policy B requires Atlas production public API diagnostic logs for the worldwide "
                "tenant population to be retained for exactly 60 days during 2026."
            ),
            "aliases": [],
            "valid_from": "2026-01-01T00:00:00Z",
            "valid_to": "2027-01-01T00:00:00Z",
