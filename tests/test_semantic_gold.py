        ...
        "compiled": [
            {
                ...
                "content": (
                    ...
                    "public API requests for the worldwide tenant population to be retained for "
                    "30 days during 2026. Restricted payloads are never included in diagnostic "
                    "logs."
                ),
            ...
            },
            {
                ...
                "content": (
                    ...
                    "public API requests for the worldwide tenant population to be retained for "
                    "60 days during 2026. Restricted payloads are never included in diagnostic "
                    "logs."
                ),
...
def test_query_claim_binding_rejects_tampered_synthesis_receipt(
        ...
        fragment_a: {
            **reference_a,
            ...
            "text": (
                ...
                "requires 30 days. Restricted payloads are never included in diagnostic logs."
            ),
        },
        fragment_b: {
            **reference_b,
            ...
            "text": (
                ...
                "public API requests for the worldwide tenant population during 2026 and "
                "requires 60 days. Restricted payloads are never included in diagnostic logs."
            ),
        },
    }
    monkeypatch.setattr(
    ...
    item = {
        ...
        "content": (
            ...
            "requires 30 days while Policy B requires 60 days. Restricted payloads are never "
            "included in either policy's diagnostic logs."
        ),
